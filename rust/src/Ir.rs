...
pub fn build_compute_fn_table() -> Vec<ComputeFn> {
    compute_fn_table! {
        ...
        290 => crate::Engine::compute_reflect_format,
        291 => crate::Engine::compute_reflect_scalar_to_str,
        // str 比较（292-297）：按 Unicode 码点序列字典序比较
        292 => crate::Engine::compute_eq_str,
        293 => crate::Engine::compute_ne_str,
        294 => crate::Engine::compute_lt_str,
        295 => crate::Engine::compute_gt_str,
        296 => crate::Engine::compute_le_str,
        297 => crate::Engine::compute_ge_str,
        // 复合类型语义相等/不等（298-299）
        298 => crate::Engine::compute_eq_obj,
        299 => crate::Engine::compute_ne_obj,
    }
}
...
const fn scalar_meta(tag: crate::Value::ScalarTag) -> Option<ScalarMeta> {
...
pub struct IrBuilder<'a> {
    ...
    pub analysis: Option<&'a crate::sema::Analyzer::AnalysisReport>,
...
impl<'a> IrBuilder<'a> {
    ...
    pub fn with_analysis(
        mut self,
        analysis: &'a crate::sema::Analyzer::AnalysisReport,
    ) -> Self {
    ...
    fn is_dead_func(&self, decl_idx: usize) -> bool {
        self.is_compiling_entry()
            && self.analysis.map_or(false, |r| r.dead_func.dead.contains(&crate::sema::Analyzer::FuncId(decl_idx as u32)))
    }

    /// 查询表达式是否为内联候选的调用点。
    /// 返回被调函数的 FuncId，IrBuilder 应展开其 body 而非 launch 子图。
    #[inline]
    fn inline_target(&self, expr_id: crate::ast::Ast::ExprId) -> Option<crate::sema::Analyzer::FuncId> {

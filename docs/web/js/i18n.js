...
const I18N_DATA = {
    zh: {
        ...
        feature_safety_desc: '<code class="inline">async fun</code> + channel 像普通函数一样写并发；按值复制隔离 + Atomic/Channel 共享，运行时保证无数据竞争',
        ...
        feature_stdlib_desc: '<code class="inline">std/io</code>、<code class="inline">std/time</code>、<code class="inline">std/net</code>、<code class="inline">std/reflect</code> 编进二进制；零安装，开箱即用',
        feature_zero_title: '类型安全抽象',
        ...
        sections: {
            ...
            'custom-error': '自定义错误',
            'strategy': '策略对照',
            'cast-builder': 'cast 构建器',
            'builtin-cast': '内建转换函数',
            'rules': '转换规则',
            'async': 'async fun 异步函数',
            'capture': '参数捕获',
            'channel': 'Channel 通道',
            'select': 'select 多路复用',
            'atomic': 'Atomic<T> 原子类型',
            'safety': '并行安全',
            'file-module': '文件即模块',
            'visibility': '可见性',
            'import': 'import 导入',
    ...
    en: {
        ...
        feature_safety_desc: '<code class="inline">async fun</code> + channel makes concurrency as natural as regular functions; value-copy isolation + Atomic/Channel sharing, runtime guarantees no data races',
        ...
        feature_stdlib_desc: '<code class="inline">std/io</code>, <code class="inline">std/time</code>, <code class="inline">std/net</code>, <code class="inline">std/reflect</code> compiled into the binary; zero install, ready to use',
        feature_zero_title: 'Type-Safe Abstraction',
        ...
        chapters: {
            ...
            adt: '4. Algebraic Data Types & Pattern Matching',
            trait: '5. Traits',

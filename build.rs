...
const EXTERN_GLUE_FILES: &[&str] = &[
    "src/stdlib/builtin/io/Raw.glue",
    "src/stdlib/builtin/net/Raw.glue",
    "src/stdlib/builtin/time/Raw.glue",
    "src/stdlib/builtin/cast/Raw.glue",
    "src/stdlib/builtin/str/Raw.glue",
];
